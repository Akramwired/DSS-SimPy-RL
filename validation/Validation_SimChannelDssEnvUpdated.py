...
if __name__ == '__main__':
    ...
    for ch in range(500,2600,500):
        ...
        for c in range(1,5,1):
            ...
            print('success rate {0} avg episode len {1} episode len only success {2}'.format(sucess/episodes, statistics.mean(app_episode_len_all),statistics.mean(agg_episode_len)))
            scipy.io.savemat('Contingency_Type_'+str(c)+'_Ch_Bw_'+str(ch)+'_goal_cp_Rql_100_remove_unsucessful.mat',results)
