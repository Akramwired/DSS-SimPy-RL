...
for c in range(500,2600,500):
    ...
    for r in range(50,130,20):
        for k in range(2,11,2):
            ...
            print('Case: Qlimit: {0}, success rate: {1}, avg episode len: {2}, avg Rtr drop rate: {3}, R3/R2 : {4}'.format(r,success/episodes, agg_episode_len/episodes,agg_rtr2_drop_rate/episodes,ratio))
            ...
            scipy.io.savemat('qlimit_'+str(r)+'_ch_BW_'+str(c)+'goal_total_10_pkt_small_case_R3_R2_ratio_0_'+str(k)+'.mat',results)
